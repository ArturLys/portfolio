...
const SERVERS: Server[] = [
  {
    id: 'email',
    name: 'Mail',
    address: 'lusartur47@gmail.com',
    icon: <Mail size={32} />,
    ping: '24ms',
    url: 'mailto:lusartur47@gmail.com',
  ...
  },
  {
    ...
    icon: <Globe size={32} />,
    ping: '45ms',
    url: 'https://linkedin.com/in/artur-lys',
    motd: 'Work history & network',
    status: 'Online',
  },
  {
    id: 'github',
