    ...
    <div className="absolute inset-0 z-20 flex flex-col items-center pt-4 bg-black/70">
      ...
      <div className="mb-2 w-[400px] max-w-[95vw] relative">
        <input
          ...
          className="w-full h-[40px] bg-black border-[2px] border-white px-2 font-minecraft text-[16px] text-white outline-none"
      ...
      <div className="pt-4 pb-12 w-[700px] max-w-[95vw] flex flex-col gap-[4px] relative z-20">
