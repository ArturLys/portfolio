...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    name: 'AI-RPG Engine',
    description:
      'RPG where AI as the Game Master dynamically manages a massive, persistent world, tracks unique NPC memories, and generates entirely new items and locations on the fly.',
    shortDescription: 'Dynamic AI Game Master Engine',
    version: 'Python / Openrouter',
    url: 'Coming soon',
    repoUrl: 'https://github.com/ArturLys/ai-rpg',
    icon: '/worlds/ai-rpg-icon.png',
    images: ['/worlds/ai-rpg-main.png', '/worlds/ai-rpg-character-example.png'],
  },
  {
    id: 'ai-image-search',
      ...
      <AnimatePresence>
        {zoomedImage && (
          ...
          >
            ...
            >
              <img src={zoomedImage} alt='Zoomed screenshot' className='max-w-full max-h-full object-contain shadow-2xl' />
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
